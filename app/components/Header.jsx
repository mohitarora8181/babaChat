...
const Header = ({ activeUser, chatDates, setPerfectDate, today }) => {
    ...
    return (
        <div className={`flex w-[65%] justify-between align-middle max-sm:hidden px-5 absolute top-20 bg-white rounded-lg translate-x-12 p-2 border border-gray-400 gap-5`}>
